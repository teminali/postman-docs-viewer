...
export default function LoginPage() {
  ...
  const { signInWithEmail, signInWithGoogle, authError, clearAuthError, isConfigured, loading } = useAuth();
      ...
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>
              Add the required environment variables to .env.local to enable login. See .env.example.
            </CardDescription>
          </CardHeader>
          <CardFooter>
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4">
      ...
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>Sign in with email or Google to continue.</CardDescription>
        </CardHeader>
